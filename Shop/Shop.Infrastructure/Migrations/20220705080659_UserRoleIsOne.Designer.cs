...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20220705080659_UserRoleIsOne")]
    partial class UserRoleIsOne
    {
            ...
            modelBuilder.Entity("Shop.Domain.ProductAgg.Product", b =>
                {
                    ...
                    b.Property<long?>("SecondrySubCategoryId")
                        .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Shop.Domain.OrderAgg.ValueObjects.ShippingMethod", "ShippingMethod", b1 =>
                        {
                            ...
                            b1.Property<string>("ShipppingType")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Shop.Domain.UserAgg.User", b =>
                {
                    ...
                    b.OwnsOne("Shop.Domain.UserAgg.UserRole", "UserRoles", b1 =>
                        {
                            b1.Property<long>("UserId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsMany("Shop.Domain.UserAgg.UserToken", "UserTokens", b1 =>
                        {
                            ...
                            b1.Property<string>("HashedRefreshToken")
                                .IsRequired()
                                .HasMaxLength(250)
                                .HasColumnType("nvarchar(250)");
